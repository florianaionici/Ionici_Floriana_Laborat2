...
using Ionici_Floriana_Lab2.Models;

namespace Ionici_Floriana_Lab2.Data
{
 ...
 new Customer{CustomerID=1050,Name="Popescu Marcela",
     BirthDate=DateTime.Parse("1979-09-01")},
 new Customer{CustomerID=1045,Name="Mihailescu Cornel",
